...
/*
 * Program:        read_ram_rand
 * Description:    Read from a binary file stored in RAM buffer at X random
 *                 positions.
 * Authors:        boodram8, phamtyle             
 */              
int main(int argc, char *argv[])
{
    const char *usage_msg = "Usage: read_ram_rand <input filename> "
    ...
    Record *buffer = (Record *) malloc(file_size);
    ...
    {
        /* Choose a random record number in intervali
